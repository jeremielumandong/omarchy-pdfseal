    ...
    Timer {
        ...
        onTriggered: {
            ...
            if (phase === 0 && doc.preview && doc.operation === "") {
                ...
                if (!control("annotationText").activeFocus) throw new Error("Page click did not focus text input");
                typeText("Signed");
                ...
                if (doc.selected !== 1 || !control("annotationText").visible) throw new Error("Existing text cannot be edited with Select");
